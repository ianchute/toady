...
Below we map 7 features of the <a href="https://www.kaggle.com/mylesoneill/world-university-rankings">world's top universities</a> onto 2d space and color the points based on university score. We also add a label for each point:
